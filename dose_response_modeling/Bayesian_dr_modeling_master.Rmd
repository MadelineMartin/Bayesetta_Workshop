...
can use this to evaluate the prior distributions for each parameter. The priors
appear to cover a broad range of response values including extreme responses. 
```{r}
...
pink and posterior is teal). This can be useful for comparing the density 
distribution of the prior and posterior.
